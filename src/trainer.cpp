...
int main(int argc,char** argv){
   ...
   CommandLineParser parser(argc, argv,
    ...
    cout << "willsong debug 5: " << imagenames.size()  << ", " << trainlandmarks.size() << endl;
    ...
    cout << "willsong debug 8: " << trainimages.size()  << ", " << trainlandmarks.size() << ", " << Trainlandmarks.size() << endl;
    cout<<"Got data"<<endl;
    cout << "willsong debug 9: " << scale << ", " << modelfile_name << endl;
